...
class Migrasi_2022070101 extends MY_model
{
    public function up()
    {
        $hasil = true;
    ...
    protected function sesuaikanTabelFormatSurat($hasil)
    {
        ...
        if (! $this->db->field_exists('masa_berlaku', $table)) {
            $fields['masa_berlaku'] = [
                'type' => 'INTEGER',
                'constraint' => 3,
                'null' => true,
        ...
        if (! $this->db->field_exists('satuan_masa_berlaku', $table)) {
            $fields['satuan_masa_berlaku'] = [
                'type' => 'VARCHAR',
                'constraint' => 15,
                'null' => true,
                'default' => 'M'
