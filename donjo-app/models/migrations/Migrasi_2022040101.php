...
class Migrasi_2022040101 extends MY_model
{
    public function up()
    {
        $hasil = true;
    ...
    public function jamKerja($hasil)
    {
        ...
        if (Schema::hasTable('kehadiran_jam_kerja') && JamKerja::withoutGlobalScope(\App\Scopes\ConfigIdScope::class)->count() != 7 && identitas('id')) {
