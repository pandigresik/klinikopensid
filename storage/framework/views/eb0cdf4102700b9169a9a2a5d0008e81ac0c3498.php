                                                ...
                                                <div class="col-md-12">
                                                    <div class="box-header with-border">
                                                        <h3 class="box-title"><strong>Migrasi Database Ke
                                                                <?php echo e(config_item('nama_aplikasi')); ?>

                                                                <?php echo e(AmbilVersi()); ?></strong></h3>
                                                    </div>
                                                    <div class="box-body">
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <form action="<?php echo e($form_action); ?>" method="post" enctype="multipart/form-data" id="excell" class="form-horizontal">
                                                                    ...
                                                                    <ul>
                                                                        ...
                                                                        <li> <a href="<?php echo e(config_item('fb_opendesa')); ?>"><?php echo e(config_item('fb_opendesa')); ?></a>
                                                                        </li>
                                                                    </ul>
                                                            ...
                                                            if (result.isConfirmed) {
                                                                ...
                                                                Swal.fire({
                                                                    ...
                                                                    didOpen() {
                                                                        ...
                                                                        $.ajax({
                                                                            url: '<?php echo e($form_action); ?>?mode=' + _mode,
                                                                            type: "POST",
                                                                            data: f,
                                                                            dataType: 'json',
                                                                            processData: !1,
                                        ...
                                        <?php $__env->stopPush(); ?>
<?php /**PATH /data/docker/opendesa/KlinikOpenSID/resources/views/admin/database/migrasi_cri.blade.php ENDPATH**/ ?>